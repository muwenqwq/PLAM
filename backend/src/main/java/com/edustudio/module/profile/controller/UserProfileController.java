...
public class UserProfileController {
    ...
    @Operation(summary = "重新分析学习空间画像")
    @PostMapping("/space/{spaceId}/analyze")
    public Result<UserProfileVO> reanalyzeBySpace(@PathVariable Long spaceId) {
        return Result.success(userProfileService.reanalyzeBySpace(spaceId));
    }
}
