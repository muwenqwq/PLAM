...
CREATE TABLE learning_space (
  ...
  is_default TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Default learning space flag',
  ...
  KEY idx_learning_space_user_default (user_id, is_default, deleted),
...
CREATE TABLE user_profile (
  id BIGINT NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  user_id BIGINT NOT NULL COMMENT 'Logical FK to sys_user.id',
  space_id BIGINT NOT NULL DEFAULT 0 COMMENT '0 for global profile, otherwise logical FK to learning_space.id',
  ...
  weak_points JSON NULL COMMENT 'Weak knowledge points',
  ...
  deleted TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Logical deletion flag',
  PRIMARY KEY (id),
  UNIQUE KEY uk_user_profile_user_space_deleted (user_id, space_id, deleted),
  KEY idx_user_profile_space (space_id, deleted),
...
CREATE TABLE learning_preference (
  ...
  output_style VARCHAR(64) NOT NULL DEFAULT 'markdown' COMMENT 'markdown, structured, concise, detailed',
  content_length_preference VARCHAR(32) NOT NULL DEFAULT 'medium' COMMENT 'short, medium, long',
  difficulty_preference VARCHAR(64) NOT NULL DEFAULT 'medium' COMMENT 'easy, medium, hard, adaptive',
  ...
  knowledge_graph_enabled TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Knowledge graph generation enabled',
  quiz_enabled TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Quiz generation enabled',
  review_plan_enabled TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Review plan enabled',
  status VARCHAR(32) NOT NULL DEFAULT 'active' COMMENT 'active, disabled',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created time',
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Updated time',
  deleted TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Logical deletion flag',
