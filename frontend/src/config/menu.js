export const menuConfig = [
    ...
    { icon: '📅', cn: '学习计划', name: 'Plan', path: '/plan', component: () => import('@/views/Plan.vue') },
    { icon: '👨‍🏫', cn: '智能辅导', name: 'Tutor', path: '/tutor', component: () => import('@/views/Tutor.vue') },
    { icon: '📊', cn: '数据统计', name: 'Statistics', path: '/statistics', component: () => import('@/views/Statistics.vue') },
    { icon: '🤖', cn: 'Agent 记录', name: 'AgentRecords', path: '/agent-records', component: () => import('@/views/AgentRecords.vue') },
    { icon: '⚙️', cn: '设置', name: 'Settings', path: '/settings', component: () => import('@/views/Setting.vue'), position: 'bottom' },
    { icon: '🚪', cn: '退出登录', name: 'Login', path: '/login', component: () => import('@/views/AgentRecords.vue'), position: 'bottom' }
];